...
const ResetPinOtpVerify = (props: any) => {
  const { theme } = useTheme();
  const styles = getStyles(theme);

  const { prevData, payload: apiPayload } = props.route?.params;
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.background }}>
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.subtitle}>
          Please verify OTP send to your email to reset Pin.
        </Text>
        ...
        <View style={styles.otpContainer}>
          ...
          {resendOtp ? (
            ...
            >
              ...
              >
                Didn’t get the OTP ?{' '}
                <Text style={{ color: '#A3A3A3' }}>Resend SMS in</Text> :{' '}
              </Text>
              <CountDownTimer
...
export default ResetPinOtpVerify;
